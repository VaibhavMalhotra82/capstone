...
def store_feedback(session_id: str, feedback: list):
    ...
    try:
        ...
        dict_feedback = {"feedback": messages_to_dict(feedback_messages)}  # Ensure feedback is serializable and always latest
...
def load_feedback(session_id: str) -> str:
    """
    ...
    if os.path.exists(feedback_path):
        with open(feedback_path, "r") as f:
            ...
            return messages_from_dict(data["feedback"])  # always return the latest feedback
    else:
