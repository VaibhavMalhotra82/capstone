...
# Sequence of decorators matters here. The @tool decorator must be the outermost one to ensure the function is registered as a tool in LangChain, while the @traceable decorator should be inside it to capture the execution details of the function when it's called as a tool.
@tool
@traceable(run_type="retriever")
async def advisory_engine(query: str, intent: str) -> dict:
    """
